...
4. Confirmed that the printer is listed in the pc's devices list by navigating to Windows settings: 'Windows key + I > Bluetooth & devices  > Printers & scanners'. Result was positive, printer was listed.
5. Opened the particular printer's settings by clicking on the printer in the list.
6. Inside the printer's settings, navigated to & clicked 'Print test page'. Result was negative; no feedback, no print-out.
...
9. Back inside the printer's settings; navigated to, & clicked on the 'Remove' button to delete printer from pc's device list. Result was positive; printer was successfully deleted from pc devices list.
10. In 'Printer & scanners' settings; navigated to, & clicked on 'Add device' > Printer on list, to re-add/install printer to pc's devices list afresh. Result positive; printer was successfully added.
11. Again, opened the particular printer settings by clicking on the printer in the pc's devices list.
12. Inside the printer's settings; navigated to & clicked 'Print test page'. Result was positive; test page request sent, received by the printer, & printed successfully.
...
## Verification:
- Test page file sent to respective printer, & printed successfully over local network wireless connection.
- User confirmed respective pc-printer wireless connection operational.
- Test ping; 4 of 4 packets delivered successfully after fix.
